...
`,""]),o.locals={contentAutoWidth:"OX1PG_WSPOEFbMr3n48l"},_.Z=o},23247:function(u,_){_.Z=`import React, { useId } from 'react';
...
`},49881:function(u,_){_.Z=`.contentAutoWidth {
  :global {
...
`},33586:function(u,_){_.Z=`import React from 'react';
...
`},90426:function(u,_){_.Z=`import { getPC, getPCA } from 'lcn';
