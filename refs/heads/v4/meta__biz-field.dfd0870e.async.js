"use strict";(self.webpackChunkantd_more=self.webpackChunkantd_more||[]).push([[4720],{36794:function(t,e,n){var a;n.r(e),n.d(e,{demos:function(){return B}});var o=n(90228),i=n.n(o),h=n(87999),p=n.n(h),r=n(75271),z=n(88045),v=n(80559),y=n(4875),b=n(68646),B={"biz-field-demo-demo1":{component:r.memo(r.lazy(function(){return n.e(7717).then(n.bind(n,90608))})),asset:{type:"BLOCK",id:"biz-field-demo-demo1",refAtomIds:["biz-field"],dependencies:{"index.tsx":{type:"FILE",value:n(29686).Z},react:{type:"NPM",value:"18.3.1"},antd:{type:"NPM",value:"5.29.3"},"antd-more":{type:"NPM",value:"4.10.9"},"../../biz-dictionary/demos/constants.ts":{type:"FILE",value:n(40609).Z}},entry:"index.tsx"},routeId:"components/biz-field/index",context:{"../../biz-dictionary/demos/constants.ts":y,react:a||(a=n.t(r,2)),antd:z,"antd-more":v,"/home/runner/work/antd-more/antd-more/src/biz-dictionary/demos/constants.ts":y},renderOpts:{compile:function(){var u=p()(i()().mark(function m(){var d,c=arguments;return i()().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:return l.next=2,n.e(1216).then(n.bind(n,54836));case 2:return l.abrupt("return",(d=l.sent).default.apply(d,c));case 3:case"end":return l.stop()}},m)}));function s(){return u.apply(this,arguments)}return s}()}},"biz-field-demo-fieldnames":{component:r.memo(r.lazy(function(){return n.e(7717).then(n.bind(n,68166))})),asset:{type:"BLOCK",id:"biz-field-demo-fieldnames",refAtomIds:["biz-field"],dependencies:{"index.tsx":{type:"FILE",value:n(43045).Z},react:{type:"NPM",value:"18.3.1"},"antd-more":{type:"NPM",value:"4.10.9"},"./currency.ts":{type:"FILE",value:n(87571).Z}},entry:"index.tsx"},routeId:"components/biz-field/index",context:{"./currency.ts":b,react:a||(a=n.t(r,2)),"antd-more":v,"/home/runner/work/antd-more/antd-more/src/biz-field/demos/currency.ts":b},renderOpts:{compile:function(){var u=p()(i()().mark(function m(){var d,c=arguments;return i()().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:return l.next=2,n.e(1216).then(n.bind(n,54836));case 2:return l.abrupt("return",(d=l.sent).default.apply(d,c));case 3:case"end":return l.stop()}},m)}));function s(){return u.apply(this,arguments)}return s}()}}}},4875:function(t,e,n){n.r(e),n.d(e,{ApproveStatusOptions:function(){return o},EApproveStatus:function(){return a}});var a=function(i){return i.Processing="1",i.Approve="2",i.Refused="3",i}({}),o=[{value:a.Processing,label:"\u5BA1\u6838\u4E2D",badge:{status:"processing"},tag:{alias:"\u5F85\u5BA1\u6838",color:"orange"}},{value:a.Approve,label:"\u5BA1\u6838\u901A\u8FC7",text:{style:{color:"green"}},badge:{status:"success"},tag:{color:"green"}},{value:a.Refused,label:"\u5BA1\u6838\u4E0D\u901A\u8FC7",text:{style:{color:"red"}},badge:{status:"error"},tag:{color:"red"},custom:{color:"purple"}}]},68646:function(t,e,n){n.r(e);var a=[{symbol:"\xA5",code:"CNY",name:"\u4EBA\u6C11\u5E01",tag:{color:"orange"}},{symbol:"$",code:"USD",name:"\u7F8E\u5143"},{symbol:"\u20AC",code:"EUR",name:"\u6B27\u5143"},{symbol:"\uFFE1",code:"GBP",name:"\u82F1\u9551"}];e.default=a},40609:function(t,e){e.Z=`// \u5BA1\u6838\u72B6\u6001
      ...
      <BizDescriptions
        ...
        items={[
          ...
          },
          {
            ...
            children: (
              <>
                <BizField value={10.1232} valueType="percent" precision={4} />\u3001
...
`},87571:function(t,e){e.Z=`const CurrencyData = [
  {
    symbol: '\xA5',
    code: 'CNY',
    name: '\u4EBA\u6C11\u5E01',
...
`},43045:function(t,e){e.Z=`import React from 'react';
