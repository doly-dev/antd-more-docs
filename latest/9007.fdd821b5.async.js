...
`,""]),o.locals={contentAutoWidth:"OX1PG_WSPOEFbMr3n48l"},_.Z=o},98905:function(u,_){_.Z=`import React, { useId } from 'react';
...
`},17274:function(u,_){_.Z=`.contentAutoWidth {
  :global {
...
`},83028:function(u,_){_.Z=`import React from 'react';
...
`},32012:function(u,_){_.Z=`import { getPC, getPCA } from 'lcn';
