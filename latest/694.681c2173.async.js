...
`,""]),o.locals={contentAutoWidth:"OX1PG_WSPOEFbMr3n48l"},_.Z=o},27718:function(u,_){_.Z=`import React, { useId } from 'react';
...
`},46788:function(u,_){_.Z=`.contentAutoWidth {
  :global {
...
`},29826:function(u,_){_.Z=`import React from 'react';
...
`},27586:function(u,_){_.Z=`import { getPC, getPCA } from 'lcn';
