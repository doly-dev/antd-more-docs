...
`,""]),o.locals={contentAutoWidth:"OX1PG_WSPOEFbMr3n48l"},_.Z=o},72961:function(u,_){_.Z=`import React, { useId } from 'react';
...
`},71203:function(u,_){_.Z=`.contentAutoWidth {
  :global {
...
`},25822:function(u,_){_.Z=`import React from 'react';
...
`},57708:function(u,_){_.Z=`import { getPC, getPCA } from 'lcn';
